                ...
                <div class="col-md-6">
                    ...
                    <div class="row ">
                        <div class="col-md-12">
                            ...
                            <h2 class="h3 mb-3 text-black">{{$checkout->trip->name}}</h2>
...
{{--                                    @foreach($carts as $cart)--}}
                                    <tr>
                                        <td class="text-black font-weight-bold"><strong>Date</strong></td>
                                        <td class="text-black"></td>
                                        <td class="text-black">{{ date('d:m:Y', strtotime($checkout->date)) }}</td>
                                    <tr>
