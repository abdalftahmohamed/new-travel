                            ...
                            <div class="p-3 p-lg-5 border bg-white">
                                <table class="table site-block-order-table mb-5">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-black">${{$request->subtotal}}</td>
                                    </tr>
                                    <tr>
                                        <td class="text-black font-weight-bold"><strong>Cart discount</strong></td>
                                        <td class="text-black"></td>
                                        <td class="text-black">${{$request->discount}}</td>
                                    </tr>
                                    <tr>
                                        <td class="text-black font-weight-bold"><strong>Order Total</strong></td>
                                        <td class="text-black font-weight-bold"><strong></strong></td>
                                        <td class="text-black font-weight-bold"><strong>${{$request->total}}</strong></td>
                                    </tr>
                                    </tbody>
                                </table>
                                ...
                                <form action="{{route('session')}}" method="POST">
                                    @csrf
                                    <input hidden="" name="total" value="{{$request->total}}">
