            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form class="custom-validation" action="{{route('admin.city.update')}}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select id="country" name="country_id" class="form-control" >
                                            <option value="" disabled selected>{{$city->country->name ?? "Choose Country"}}</option>
                                            @foreach($countries as $country)
                                                <option value="{{ $country->id }}" {{ old('country') == $country ? 'selected' : '' }}>{{ $country->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('country')
                                ...
                                <div class="row">
                                    <div class="col-md-auto">
                                        <div class="DocumentSection_section__3WaJL">
                                            <div class="DocumentSection_sectionTitle__1rl5y">city image
