                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="callout callout-info">
                            <strong><i class="fas fa-info"></i> Note:</strong>This page has been enhanced for printing. Click the print button at the bottom of the city to test.
                        </div>


                        <!-- Main content -->
                        <div class="city p-3 mb-3">
                            <!-- title row -->
                            <div class="row">
                                <div class="col-12">
                                    <h4>
                                        <i class="fas fa-globe"></i> Constructor
                                        <small class="float-right">Date: {{ date('d:m:Y', strtotime($city->created_at)) }}</small>
                                    </h4>
                                </div>
                                <!-- /.col -->
                            </div>
                            ...
                            <div class="row city-info">
                                <div class="col-sm-4 city-col">
                                   <h2>*city details: </h2>
                                    <address>
                                        <img class="img-fluid mb-2 rounded-circle" style="width: 150px; height: 150px;" src="{{(! empty($city->Company->logo)) ? asset('attachments/city/'.$city->Company->id.'/'.$city->Company->logo ) : asset('admin/dist/img/no_image.jpg') }}" alt="city image">

                                        <br>
                                        <strong>{{$city->Company->name ?? "Company name"}}, {{$city->Company->specialization ?? "specialization Here"}} .</strong><br>
                                        Email: <strong>{{$city->Company->email ?? "Email.com"}}</strong><br>
                                        <strong>{{$city->Company->city ?? "city"}}, {{$city->Company->governorate?? "governorate"}}</strong><br>
                                        <strong>{{$city->Company->city ?? "city"}}, {{$city->Company->zip_code ?? "C550"}}</strong><br>
                                        Phone: <strong>{{$city->Company->phone ?? "phone"}}</strong>
                                    </address>
                                </div>
                                <!-- /.col -->
                            ...
                            <div class="col-sm-auto city-col">
                                <h2>*city details: </h2>
                                <address>
                                    {{--                                        <img class="img-fluid mb-2 rounded-circle" style="width: 150px; height: 150px;" src="{{(! empty($city->image)) ? asset('attachments/city/'.$city->id.'/'.$city->image ) : asset('admin/dist/img/no_image.jpg') }}" alt="city image">--}}
                                    name:  <strong>{{$city->city_name ?? "name"}}</strong><br>
                                    description: <strong>{{$city->city_description ?? "city description..."}}</strong><br>
                                </address>
                            </div>
                            ...
                            <div class="row expandable-body" >
                                @foreach($city->attachments()->get() as $citys_attachements)
                                    @foreach($citys_attachements->Images()->get() as $images)
                                        <img class="img-fluid mb-2 " style=" padding: 5px;margin-left: 10px; width: 150px; height: 150px;" src="{{(! empty($images->image_path)) ? asset('attachments/images/city/'.$city->id.'/'.$images->attachment_id.'/'.$images->image_path ) : asset('admin/dist/img/no_image.jpg') }}" alt="image">
                                    @endforeach
                                @endforeach
                            </div>
                            ...
                            {{--                                <hr>--}}
                            {{--                                @foreach($city->attachments()->get() as $citys_attachements)--}}
                            {{--                                    @foreach($citys_attachements->Documents()->get() as $documents)--}}
                            {{--                                        <div style="position: relative; display: inline-block;">--}}
                            {{--                                            <embed src="{{ (!empty($documents->document)) ? asset('attachments/documents/city/'.$city->id.'/'.$documents->attachment_id.'/'.$documents->document) : asset('admin/dist/img/no_image.jpg') }}" type="application/pdf" style="padding: 5px; margin-left: 10px; width: 180px; height: 150px;" />--}}
                            {{--                                            <a href="{{ (!empty($documents->document)) ? asset('attachments/documents/city/'.$city->id.'/'.$documents->attachment_id.'/'.$documents->document) : '#' }}" download="document.pdf" style="position: absolute; bottom: 0; left: 50%; transform: translateX(-50%); margin-top: 5px;">Download</a>--}}
                            {{--                                        </div>--}}
                            {{--                                    @endforeach--}}
                            {{--                                @endforeach--}}
                            {{--                            </div>--}}
...
{{--                                                        <td>{{$quote->city->first_name}}</td>--}}
                                                        <td>{{mb_substr($quote->city->city_name,0,30). '...'}}</td>
                                                        <td>
...
{{--                                                        </td>--}}
                            ...
                            <div class="row">
                                ...
                                <!-- /.col -->
                                {{--                                <div class="col-6">--}}
                                {{--                                    <p class="lead">Amount Due {{$city->issued_date}}</p>--}}
                                ...
                                {{--                                            </tr>--}}
                                {{--                                            <tr>--}}
                                {{--                                                <th>Tax ({{$city->tax->ratio}}%)</th>--}}
                                {{--                                                <td>${{$tax}}</td>--}}
                                {{--                                            </tr>--}}
                                {{--                                            <tr>--}}
                                {{--                                                <th>Discount:</th>--}}
                                {{--                                                <td>${{$city->discount->value}}</td>--}}
                                {{--                                            </tr>--}}
                                {{--                                            <tr>--}}
                                {{--                                                <th>Total:</th>--}}
                                {{--                                                <td>${{$city->total}}</td>--}}
                            ...
                            <div class="row no-print">
                                <div class="col-12">
                                    {{--                                    <a href="city-print.html" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>--}}
