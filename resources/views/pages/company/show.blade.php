                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="callout callout-info">
                            <strong><i class="fas fa-info"></i> Note:</strong>This page has been enhanced for printing. Click the print button at the bottom of the company to test.
                        </div>


                        <!-- Main content -->
                        <div class="company p-3 mb-3">
                            <!-- title row -->
                            <div class="row">
                                <div class="col-12">
                                    <h4>
                                        <i class="fas fa-globe"></i> Constructor
                                        <small class="float-right">Date: {{ date('d:m:Y', strtotime($company->created_at)) }}</small>
                                    </h4>
                                </div>
                                <!-- /.col -->
                            </div>
                            ...
                            <div class="row company-info">
                                <div class="col-sm-4 company-col">
                                   <h2>*company details: </h2>
                                    <address>
                                        <img class="img-fluid mb-2 rounded-circle" style="width: 150px; height: 150px;" src="{{(! empty($company->Company->logo)) ? asset('attachments/company/'.$company->Company->id.'/'.$company->Company->logo ) : asset('admin/dist/img/no_image.jpg') }}" alt="company image">

                                        <br>
                                        <strong>{{$company->Company->name ?? "Company name"}}, {{$company->Company->specialization ?? "specialization Here"}} .</strong><br>
                                        Email: <strong>{{$company->Company->email ?? "Email.com"}}</strong><br>
                                        <strong>{{$company->Company->country ?? "country"}}, {{$company->Company->governorate?? "governorate"}}</strong><br>
                                        <strong>{{$company->Company->city ?? "city"}}, {{$company->Company->zip_code ?? "C550"}}</strong><br>
                                        Phone: <strong>{{$company->Company->phone ?? "phone"}}</strong>
                                    </address>
                                </div>
                                <!-- /.col -->
                            ...
                            <div class="col-sm-auto company-col">
                                <h2>*company details: </h2>
                                <address>
                                    {{--                                        <img class="img-fluid mb-2 rounded-circle" style="width: 150px; height: 150px;" src="{{(! empty($company->image)) ? asset('attachments/company/'.$company->id.'/'.$company->image ) : asset('admin/dist/img/no_image.jpg') }}" alt="company image">--}}
                                    name:  <strong>{{$company->company_name ?? "name"}}</strong><br>
                                    description: <strong>{{$company->company_description ?? "company description..."}}</strong><br>
                                </address>
                            </div>
                            ...
                            <div class="row expandable-body" >
                                @foreach($company->attachments()->get() as $companys_attachements)
                                    @foreach($companys_attachements->Images()->get() as $images)
                                        <img class="img-fluid mb-2 " style=" padding: 5px;margin-left: 10px; width: 150px; height: 150px;" src="{{(! empty($images->image_path)) ? asset('attachments/images/company/'.$company->id.'/'.$images->attachment_id.'/'.$images->image_path ) : asset('admin/dist/img/no_image.jpg') }}" alt="image">
                                    @endforeach
                                @endforeach
                            </div>
                            ...
                            {{--                                <hr>--}}
                            {{--                                @foreach($company->attachments()->get() as $companys_attachements)--}}
                            {{--                                    @foreach($companys_attachements->Documents()->get() as $documents)--}}
                            {{--                                        <div style="position: relative; display: inline-block;">--}}
                            {{--                                            <embed src="{{ (!empty($documents->document)) ? asset('attachments/documents/company/'.$company->id.'/'.$documents->attachment_id.'/'.$documents->document) : asset('admin/dist/img/no_image.jpg') }}" type="application/pdf" style="padding: 5px; margin-left: 10px; width: 180px; height: 150px;" />--}}
                            {{--                                            <a href="{{ (!empty($documents->document)) ? asset('attachments/documents/company/'.$company->id.'/'.$documents->attachment_id.'/'.$documents->document) : '#' }}" download="document.pdf" style="position: absolute; bottom: 0; left: 50%; transform: translateX(-50%); margin-top: 5px;">Download</a>--}}
                            {{--                                        </div>--}}
                            {{--                                    @endforeach--}}
                            {{--                                @endforeach--}}
                            {{--                            </div>--}}
...
{{--                                                        <td>{{$invoice->company->first_name}}</td>--}}
...
{{--                                                        <td>{{$quote->company->first_name}}</td>--}}
                                                        <td>{{mb_substr($quote->company->company_name,0,30). '...'}}</td>
                                                        <td>
...
{{--                                                        </td>--}}
                            ...
                            <div class="row">
                                ...
                                <!-- /.col -->
                                {{--                                <div class="col-6">--}}
                                {{--                                    <p class="lead">Amount Due {{$company->issued_date}}</p>--}}

                                {{--                                    <div class="table-responsive">--}}
                                {{--                                        <table class="table">--}}
                                {{--                                            <tr>--}}
                                {{--                                                <th style="width:50%">Subtotal:</th>--}}
                                {{--                                                <td>${{$company->subtotal}}</td>--}}
                                {{--                                            </tr>--}}
                                {{--                                            <tr>--}}
                                {{--                                                <th>Tax ({{$company->tax->ratio}}%)</th>--}}
                                {{--                                                <td>${{$tax}}</td>--}}
                                {{--                                            </tr>--}}
                                {{--                                            <tr>--}}
                                {{--                                                <th>Discount:</th>--}}
                                {{--                                                <td>${{$company->discount->value}}</td>--}}
                                {{--                                            </tr>--}}
                                {{--                                            <tr>--}}
                                {{--                                                <th>Total:</th>--}}
                                {{--                                                <td>${{$company->total}}</td>--}}
                            ...
                            <div class="row no-print">
                                <div class="col-12">
                                    {{--                                    <a href="company-print.html" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>--}}
