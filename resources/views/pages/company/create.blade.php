...
{{--                        </div>--}}
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form class="custom-validation" action="{{route('admin.company.store')}}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <input type="email" name="email" value="{{old('email')}}"
                                               class="form-control" required placeholder="enter company email here..."/>
                                        @error('email')
                                        <span class="text-danger" role="alert">
                                        <strong>{{$message}}</strong>
                                    </span>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="tel" name="phone" value="{{old('phone')}}"
                                               class="form-control" required placeholder="enter company phone here..."/>
                                        @error('phone')
                                        <span class="text-danger" role="alert">
                                        <strong>{{$message}}</strong>
                                    </span>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="url" name="url" value="{{old('url')}}"
                                               class="form-control" required placeholder="enter company url here..."/>
                                        @error('url')
                                        <span class="text-danger" role="alert">
                                        <strong>{{$message}}</strong>
                                    </span>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <input type="password" name="password" value="{{old('password')}}"
                                               class="form-control" required placeholder="enter company password here..."/>
                                        @error('password')
                                        <span class="text-danger" role="alert">
                                        <strong>{{$message}}</strong>
                                    </span>
