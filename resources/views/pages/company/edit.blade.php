            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form class="custom-validation" action="{{route('admin.company.update')}}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <select id="country_id" name="country_id" class="form-control"  onchange="getCities()">
                                            <option value="" disabled selected>{{$company->country->name ?? "Choose Country"}}</option>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select id="city_id" name="city_id" class="form-control" >
                                            <option value="" disabled selected>{{$company->city->name ?? "Choose City"}}</option>
                                        </select>
                                        @error('city_id')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <input type="email" name="email" value="{{$company->email,old('email')}}"
                                               class="form-control"  placeholder="enter company email here..."/>
                                        @error('email')
                                        <span class="text-danger" role="alert">
                                        <strong>{{$message}}</strong>
                                    </span>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="tel" name="phone" value="{{$company->phone,old('phone')}}"
                                               class="form-control"  placeholder="enter company phone here..."/>
                                        @error('phone')
                                        <span class="text-danger" role="alert">
                                        <strong>{{$message}}</strong>
                                    </span>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="url" name="url" value="{{$company->url,old('url')}}"
                                               class="form-control"  placeholder="enter company url here..."/>
                                        @error('url')
                                        <span class="text-danger" role="alert">
                                        <strong>{{$message}}</strong>
                                    </span>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <input type="password" name="password" value="{{old('password')}}"
                                               class="form-control"  placeholder="enter company password here..."/>
                                        @error('password')
                                        <span class="text-danger" role="alert">
                                        <strong>{{$message}}</strong>
                                    </span>
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <label>the company name ar</label>
                                        <input type="text" name="name_ar" value="{{$company->getTranslation('name','ar'),old('name_ar')}}"
                                    ...
                                    <div class="col-4">
                                        <label>the company name en</label>
                                        <input type="text" name="name_en" value="{{$company->getTranslation('name','en'),old('name_en')}}"
                                    ...
                                    <div class="col-4">
                                        <label>the company name ur</label>
                                        <input type="text" name="name_ur" value="{{$company->getTranslation('name','ur'),old('name_ur')}}"
                                               class="form-control" required placeholder="enter company name_en here..."/>
                                        @error('name_ur')
                                        <span class="text-danger" role="alert">
                                        <strong>{{$message}}</strong>
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <label>the company address ar</label>
                                        <input type="text" name="address_ar" value="{{$company->getTranslation('address','ar'),old('address_ar')}}"
                                    ...
                                    <div class="col-4">
                                        <label>the company address en</label>
                                        <input type="text" name="address_en" value="{{$company->getTranslation('address','en'),old('address_en')}}"
                                    ...
                                    <div class="col-4">
                                        <label>the company address ur</label>
                                        <input type="text" name="address_ur" value="{{$company->getTranslation('address','ur'),old('address_ur')}}"
                                               class="form-control"  placeholder="enter company address_en here..."/>
                                        @error('address_ur')
                                        <span class="text-danger" role="alert">
                                        <strong>{{$message}}</strong>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <select name="status" class="form-control" >
                                            <option selected disabled value="">{{$company->status ?? "Choose..."}}</option>
                                            <option
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-auto">
                                        <img id="showImage" class="rounded avatar-lg"
                                             src="{{(! empty($company->image_path)) ? asset('attachments/companys/'.$company->id.'/'.$company->image_path ) : asset('admin/dist/img/no_image.jpg') }}"
