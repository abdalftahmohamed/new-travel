            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-ssubscriptionEmailed">
                                <thead>
                                <tr>
                                    <th>#</th>
                                ...
                                <tbody>
                                @foreach($subscriptionEmails as $subscriptionEmail)
                                    <tr>
                                        <td>{{$loop->iteration}}</td>
                                        <td>{{$subscriptionEmail->name}}</td>
                                        <td>{{$subscriptionEmail->email}}</td>
                                        <td>
                                            <div class="margin">
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        <form action="{{route('admin.subscriptionEmail.destroy')}}" method="POST"
                                                              style="display: inline-block;">
                                                            @csrf
                                                            @method('DELETE')
                                                            <input type="hidden" name="id" value="{{$subscriptionEmail->id}}">
                                                            <button type="submit"
