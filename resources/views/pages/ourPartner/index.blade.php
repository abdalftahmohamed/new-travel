                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>
                                <a href="{{route('admin.ourPartner.create')}}"
                                   class="btn btn-primary waves-effect waves-light float-end mb-4">Create ourPartner</a>
                            </h4>
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-sourPartnered">
                                <thead>
                                <tr>
                                    <th>#</th>
                                    <th>name</th>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        <a class="dropdown-item"
                                                           href="{{route('admin.ourPartner.edit', $ourPartner->id)}}">Edit</a>
                                                        <div class="dropdown-divider"></div>
                                                        <form action="{{route('admin.ourPartner.destroy')}}" method="POST"
