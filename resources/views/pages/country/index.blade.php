                        ...
                        <div class="card-header">
                            <h4>
                                <a href="{{route('admin.country.create')}}"
                                   class="btn btn-primary waves-effect waves-light float-end mb-4">Create Country</a>
                            </h4>
...
{{--                                    <th>Show</th>--}}
                                ...
                                @foreach($countrys as $country)
                                    <tr>
                                        ...
                                        <td>{{$country->name}}</td>
                                        <td>{{mb_substr($country->description,0,40). '...'}}</td>
                                        <td>
                                            <img class="img-fluid mb-2 rounded-circle" style="width: 150px; height: 150px;" src="{{(! empty($country->image_path)) ? asset('attachments/countrys/'.$country->id.'/'.$country->image_path ) : asset('admin/dist/img/no_image.jpg') }}" alt="client image">
                                        </td>
{{--                                        <td>--}}
{{--                                            <a class="dropdown-item" href="{{ route('admin.country.show', $country->id) }}" style="display: flex;padding-top: 20px; justify-content: center; align-items: center;">--}}
