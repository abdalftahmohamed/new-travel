                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($countrys as $country)
                                    <tr>
                                        ...
                                        <td>
                                            <img class="img-fluid mb-2 " style="width: 150px; height: 150px;" src="{{(! empty($country->image_path)) ? asset('attachments/countrys/'.$country->id.'/'.$country->image_path ) : asset('admin/dist/img/no_image.jpg') }}" alt="client image">
                                        </td>
                                        <td>
