                            ...
                            <form class="custom-validation" action="{{route('admin.country.update')}}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select id="name" name="name" class="form-control" >
                                            <option value="" disabled selected>{{$country->name ?? "Select Here"}}</option>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div>
                                            <textarea name="description" class="form-control" rows="5" placeholder="enter the description here ...">{{$country->description,old('description')}}</textarea>
                                        </div>
                                        @error('description')
                                        <span class="text-danger" role="alert">
                                        <strong>{{$message}}</strong>
