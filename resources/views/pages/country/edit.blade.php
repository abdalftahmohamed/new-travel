            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form class="custom-validation" action="{{route('admin.country.update')}}" method="POST"
...
{{--                                name --}}
                                <div class="row">
                                    <div class="col-4">
                                        ...
                                        <input type="text" name="name_ar" value="{{$country->getTranslation('name','ar'),old('name_ar')}}"
                                    ...
                                    <div class="col-4">
                                        <label>the country name en</label>
                                        <input type="text" name="name_en" value="{{$country->getTranslation('name','en'),old('name_en')}}"
                                    ...
                                    <div class="col-4">
                                        <label>the country name ur</label>
                                        <input type="text" name="name_ur" value="{{$country->getTranslation('name','ur'),old('name_ur')}}"
                                               class="form-control" required placeholder="enter company name_en here..."/>
                                        @error('name_ur')
                                        <span class="text-danger" role="alert">
                                        <strong>{{$message}}</strong>
...
{{--                                des ar--}}
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div>
                                            <textarea name="description_ar" class="form-control" rows="5" placeholder="enter the description ar here ...">{{$country->getTranslation('description','ar'),old('description_ar')}}</textarea>
                                        </div>
...
{{--                                des en--}}
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div>
                                            <textarea name="description_en" class="form-control" rows="5" placeholder="enter the description en here ...">{{$country->getTranslation('description','en'),old('description_en')}}</textarea>
                                        </div>
...
{{--                                des ur--}}
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div>
                                            <textarea name="description_ur" class="form-control" rows="5" placeholder="enter the description or here ...">{{$country->getTranslation('description','ur'),old('description_ur')}}</textarea>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-auto">
                                        <div class="DocumentSection_section__3WaJL">
                                            <div class="DocumentSection_sectionTitle__1rl5y">country's flag
                                    ...
                                    <div class="col-md-auto">
                                        <img id="showImage" class="rounded avatar-lg"
                                             src="{{(! empty($country->image_path)) ? asset('attachments/countrys/'.$country->id.'/'.$country->image_path ) : asset('admin/dist/img/no_image.jpg') }}"
