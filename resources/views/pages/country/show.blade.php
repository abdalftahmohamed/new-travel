                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="callout callout-info">
                            <strong><i class="fas fa-info"></i> Note:</strong>This page has been enhanced for printing. Click the print button at the bottom of the country to test.
                        </div>


                        <!-- Main content -->
                        <div class="country p-3 mb-3">
                            <!-- title row -->
                            <div class="row">
                                <div class="col-12">
                                    <h4>
                                        <i class="fas fa-globe"></i> Constructor
                                        <small class="float-right">Date: {{ date('d:m:Y', strtotime($country->created_at)) }}</small>
                                    </h4>
                                </div>
                                <!-- /.col -->
                            </div>
                            ...
                            <div class="row country-info">
                                <div class="col-sm-4 country-col">
                                   <h2>*country details: </h2>
                                    <address>
                                        <img class="img-fluid mb-2 rounded-circle" style="width: 150px; height: 150px;" src="{{(! empty($country->Company->logo)) ? asset('attachments/country/'.$country->Company->id.'/'.$country->Company->logo ) : asset('admin/dist/img/no_image.jpg') }}" alt="country image">

                                        <br>
                                        <strong>{{$country->Company->name ?? "Company name"}}, {{$country->Company->specialization ?? "specialization Here"}} .</strong><br>
                                        Email: <strong>{{$country->Company->email ?? "Email.com"}}</strong><br>
                                        <strong>{{$country->Company->country ?? "country"}}, {{$country->Company->governorate?? "governorate"}}</strong><br>
                                        <strong>{{$country->Company->city ?? "city"}}, {{$country->Company->zip_code ?? "C550"}}</strong><br>
                                        Phone: <strong>{{$country->Company->phone ?? "phone"}}</strong>
                                    </address>
                                </div>
                                <!-- /.col -->
                            ...
                            <div class="col-sm-auto country-col">
                                <h2>*country details: </h2>
                                <address>
                                    {{--                                        <img class="img-fluid mb-2 rounded-circle" style="width: 150px; height: 150px;" src="{{(! empty($country->image)) ? asset('attachments/country/'.$country->id.'/'.$country->image ) : asset('admin/dist/img/no_image.jpg') }}" alt="country image">--}}
                                    name:  <strong>{{$country->country_name ?? "name"}}</strong><br>
                                    description: <strong>{{$country->country_description ?? "country description..."}}</strong><br>
                                </address>
                            </div>
                            ...
                            <div class="row expandable-body" >
                                @foreach($country->attachments()->get() as $countrys_attachements)
                                    @foreach($countrys_attachements->Images()->get() as $images)
                                        <img class="img-fluid mb-2 " style=" padding: 5px;margin-left: 10px; width: 150px; height: 150px;" src="{{(! empty($images->image_path)) ? asset('attachments/images/country/'.$country->id.'/'.$images->attachment_id.'/'.$images->image_path ) : asset('admin/dist/img/no_image.jpg') }}" alt="image">
                                    @endforeach
                                @endforeach
                            </div>
                            ...
                            {{--                                <hr>--}}
                            {{--                                @foreach($country->attachments()->get() as $countrys_attachements)--}}
                            {{--                                    @foreach($countrys_attachements->Documents()->get() as $documents)--}}
                            {{--                                        <div style="position: relative; display: inline-block;">--}}
                            {{--                                            <embed src="{{ (!empty($documents->document)) ? asset('attachments/documents/country/'.$country->id.'/'.$documents->attachment_id.'/'.$documents->document) : asset('admin/dist/img/no_image.jpg') }}" type="application/pdf" style="padding: 5px; margin-left: 10px; width: 180px; height: 150px;" />--}}
                            {{--                                            <a href="{{ (!empty($documents->document)) ? asset('attachments/documents/country/'.$country->id.'/'.$documents->attachment_id.'/'.$documents->document) : '#' }}" download="document.pdf" style="position: absolute; bottom: 0; left: 50%; transform: translateX(-50%); margin-top: 5px;">Download</a>--}}
                            {{--                                        </div>--}}
                            {{--                                    @endforeach--}}
                            {{--                                @endforeach--}}
                            {{--                            </div>--}}
...
{{--                                                        <td>{{$invoice->country->first_name}}</td>--}}
...
{{--                                                        <td>{{$quote->country->first_name}}</td>--}}
                                                        <td>{{mb_substr($quote->country->country_name,0,30). '...'}}</td>
                                                        <td>
...
{{--                                                        </td>--}}
                            ...
                            <div class="row">
                                ...
                                <!-- /.col -->
                                {{--                                <div class="col-6">--}}
                                {{--                                    <p class="lead">Amount Due {{$country->issued_date}}</p>--}}

                                {{--                                    <div class="table-responsive">--}}
                                {{--                                        <table class="table">--}}
                                {{--                                            <tr>--}}
                                {{--                                                <th style="width:50%">Subtotal:</th>--}}
                                {{--                                                <td>${{$country->subtotal}}</td>--}}
                                {{--                                            </tr>--}}
                                {{--                                            <tr>--}}
                                {{--                                                <th>Tax ({{$country->tax->ratio}}%)</th>--}}
                                {{--                                                <td>${{$tax}}</td>--}}
                                {{--                                            </tr>--}}
                                {{--                                            <tr>--}}
                                {{--                                                <th>Discount:</th>--}}
                                {{--                                                <td>${{$country->discount->value}}</td>--}}
                                {{--                                            </tr>--}}
                                {{--                                            <tr>--}}
                                {{--                                                <th>Total:</th>--}}
                                {{--                                                <td>${{$country->total}}</td>--}}
                            ...
                            <div class="row no-print">
                                <div class="col-12">
                                    {{--                                    <a href="country-print.html" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>--}}
