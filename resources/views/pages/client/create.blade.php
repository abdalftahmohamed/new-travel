...
{{--                        </div>--}}
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form class="custom-validation" action="{{route('admin.client.store')}}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <input type="tel" name="phone" value="{{old('phone')}}"
                                               class="form-control" required placeholder="enter client phone here..."/>
                                        @error('phone')
                                        <span class="text-danger" role="alert">
                                        <strong>{{$message}}</strong>
                                    </span>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="address" value="{{old('address')}}"
                                               class="form-control" required placeholder="enter client address here..."/>
                                        @error('address')
                                        <span class="text-danger" role="alert">
                                        <strong>{{$message}}</strong>
                                    </span>
