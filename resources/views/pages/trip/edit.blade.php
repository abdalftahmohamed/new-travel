            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form class="custom-validation" action="{{route('admin.trip.update')}}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select id="company_id" name="company_id" class="form-control" >
                                            <option value="" disabled selected>{{$trip->company->name ?? "Select Here..."}}</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select id="department_id" name="department_id" class="form-control" >
                                            <option value="" disabled selected>{{$trip->department->name ?? "Select Here..."}}</option>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="location" value="{{$trip->location,old('location')}}"
                                               class="form-control"  placeholder="enter trip location here..."/>
                                        @error('location')
                                        <span class="text-danger" role="alert">
                                        <strong>{{$message}}</strong>
                                    </span>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <select name="type" class="form-control">
                                            <option selected disabled value="">{{$trip->type ?? "Choose..."}}</option>
                                            <option
