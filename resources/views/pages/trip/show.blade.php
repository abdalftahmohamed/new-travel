                    ...
                    <div class="card">
                        ...
                        <div class="trip p-3 mb-3">
                            ...
                            <div class="row trip-info">
                                <div class="col-sm-4 trip-col">
                                   <h2>*trip details: </h2>
                                    <address>
                                        <img class="img-fluid mb-2 rounded-circle" style="width: 150px; height: 150px;" src="{{(! empty($trip->Company->logo)) ? asset('attachments/trip/'.$trip->Company->id.'/'.$trip->Company->logo ) : asset('admin/dist/img/no_image.jpg') }}" alt="trip image">

                                        <br>
                                        <strong>{{$trip->Company->name ?? "Company name"}}, {{$trip->Company->specialization ?? "specialization Here"}} .</strong><br>
                                        Email: <strong>{{$trip->Company->email ?? "Email.com"}}</strong><br>
                                        <strong>{{$trip->Company->country ?? "country"}}, {{$trip->Company->governorate?? "governorate"}}</strong><br>
                                        <strong>{{$trip->Company->city ?? "city"}}, {{$trip->Company->zip_code ?? "C550"}}</strong><br>
                            ...
                            <div class="col-sm-auto trip-col">
                                <h2>*trip details: </h2>
                                <address>
                                    {{--                                        <img class="img-fluid mb-2 rounded-circle" style="width: 150px; height: 150px;" src="{{(! empty($trip->image)) ? asset('attachments/trip/'.$trip->id.'/'.$trip->image ) : asset('admin/dist/img/no_image.jpg') }}" alt="trip image">--}}
                            ...
                            <div class="row expandable-body" >
                                @foreach($trip->attachments()->get() as $trips_attachements)
                                    @foreach($trips_attachements->Images()->get() as $images)
                                        <img class="img-fluid mb-2 " style=" padding: 5px;margin-left: 10px; width: 150px; height: 150px;" src="{{(! empty($images->image_path)) ? asset('attachments/images/trip/'.$trip->id.'/'.$images->attachment_id.'/'.$images->image_path ) : asset('admin/dist/img/no_image.jpg') }}" alt="image">
                                    @endforeach
                                @endforeach
                            </div>
                            ...
                            {{--                                <hr>--}}
                            {{--                                @foreach($trip->attachments()->get() as $trips_attachements)--}}
                            {{--                                    @foreach($trips_attachements->Documents()->get() as $documents)--}}
                            {{--                                        <div style="position: relative; display: inline-block;">--}}
                            {{--                                            <embed src="{{ (!empty($documents->document)) ? asset('attachments/documents/trip/'.$trip->id.'/'.$documents->attachment_id.'/'.$documents->document) : asset('admin/dist/img/no_image.jpg') }}" type="application/pdf" style="padding: 5px; margin-left: 10px; width: 180px; height: 150px;" />--}}
                            {{--                                            <a href="{{ (!empty($documents->document)) ? asset('attachments/documents/trip/'.$trip->id.'/'.$documents->attachment_id.'/'.$documents->document) : '#' }}" download="document.pdf" style="position: absolute; bottom: 0; left: 50%; transform: translateX(-50%); margin-top: 5px;">Download</a>--}}
                            {{--                                        </div>--}}
                            {{--                                    @endforeach--}}
                            {{--                                @endforeach--}}
                            {{--                            </div>--}}
...
{{--                                                        <td>{{$quote->trip->first_name}}</td>--}}
                                                        <td>{{mb_substr($quote->trip->name,0,30). '...'}}</td>
                                                        <td>
...
{{--                                                        </td>--}}
                            ...
                            <div class="row">
                                ...
                                <!-- /.col -->
                                {{--                                <div class="col-6">--}}
                                {{--                                    <p class="lead">Amount Due {{$trip->issued_date}}</p>--}}
