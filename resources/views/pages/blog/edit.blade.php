            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form class="custom-validation" action="{{route('admin.blog.update')}}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-md-auto">
                                        <div class="DocumentSection_section__3WaJL">
                                            <div class="DocumentSection_sectionTitle__1rl5y">blog image
                                    ...
                                    <div class="col-md-auto">
                                        <img id="showImage" class="rounded avatar-lg"
                                             src="{{(! empty($blog->image_path)) ? asset('attachments/blogs/'.$blog->id.'/'.$blog->image_path ) : asset('admin/dist/img/no_image.jpg') }}"
...
{{--                                    <div class="col-md-auto">--}}
{{--                                        <div class="DocumentSection_section__3WaJL">--}}
{{--                                            <div class="DocumentSection_sectionTitle__1rl5y">Attachments Documents--}}
{{--                                                <svg fill="none" viewBox="0 0 64 20"--}}
{{--                                                     class="DocumentEditForm_icon__3iujO">--}}
{{--                                                    <title>pro_icon</title>--}}
{{--                                                    <path fill="#484ADF" fill-rule="evenodd"--}}
...
{{--                                                </svg>--}}
{{--                                            </div>--}}
{{--                                            <div class="DocumentEditScreen_titleDescription__2abbu">Add supporting--}}
{{--                                                files, packaged neatly with the estimate or invoice when you send--}}
{{--                                                them(maximum 10).<span--}}
{{--                                                    class="DocumentEditScreen_titleDescriptionConstraints__2GG_t">(maximum 10).<svg--}}
{{--                                                        viewBox="0 0 24 24" class="DocumentAttachments_icon__38lKa"><path--}}
{{--                                                            fill-rule="evenodd"--}}
{{--                                                            d="M15.07 11.25l-.9.92C13.45 12.9 13 13.5 13 15h-2v-.5c0-1.1.45-2.1 1.17-2.83l1.24-1.26c.37-.36.59-.86.59-1.41 0-1.1-.9-2-2-2s-2 .9-2 2H8c0-2.21 1.79-4 4-4s4 1.79 4 4c0 .88-.36 1.68-.93 2.25zM11 19h2v-2h-2v2zm1-17C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z"--}}
...
{{--                                                    fill="#7DB00E"/>--}}
{{--                                            </svg>--}}
{{--                                            <input style="display: none" type="file" name="documents[]"--}}
{{--                                                   accept=".pdf,.doc,.docx" multiple id="documents">--}}
{{--                                            @error('documents')--}}
{{--                                            <span class="text-danger" role="alert">--}}
{{--                                                                                <strong>{{$message}}</strong>--}}
{{--                                                                            </span>--}}
...
{{--                                    <div class="col-md-auto">--}}
{{--                                        <img id="showDocuments" class="rounded avatar-lg"--}}
{{--                                             src="{{asset('admin/dist/img/no_image.jpg') }}"--}}
{{--                                             style="max-width: 100%; max-height: 300px; margin-left: 80px;"--}}
{{--                                             alt="No Document">--}}
{{--                                    </div>--}}
...
{{--                                    <div class="col-md-auto">--}}
{{--                                        <div class="DocumentSection_section__3WaJL">--}}
{{--                                            <div class="DocumentSection_sectionTitle__1rl5y">Attachments Videos--}}
{{--                                                <svg fill="none" viewBox="0 0 64 20"--}}
{{--                                                     class="DocumentEditForm_icon__3iujO">--}}
{{--                                                    <title>pro_icon</title>--}}
{{--                                                    <path fill="#484ADF" fill-rule="evenodd"--}}
...
{{--                                            </div>--}}
{{--                                            <div class="DocumentEditScreen_titleDescription__2abbu">Add supporting--}}
{{--                                                Videos, packaged neatly with the estimate or invoice when you send--}}
{{--                                                them(maximum 10).<span--}}
{{--                                                    class="DocumentEditScreen_titleDescriptionConstraints__2GG_t">(maximum 10).<svg--}}
{{--                                                        viewBox="0 0 24 24" class="DocumentAttachments_icon__38lKa"><path--}}
{{--                                                            fill-rule="evenodd"--}}
...
{{--                                                    fill="#7DB00E"/>--}}
{{--                                            </svg>--}}
{{--                                            <input style="display: none" type="file" name="videos[]"--}}
{{--                                                   accept="video/*" multiple id="videos">--}}
{{--                                            @error('videos')--}}
{{--                                            <span class="text-danger" role="alert">--}}
{{--                                                                                <strong>{{$message}}</strong>--}}
{{--                                                                            </span>--}}
...
{{--                                    </div>--}}
{{--                                    <div class="col-md-auto">--}}
{{--                                        <img id="showVideos" class="rounded avatar-lg"--}}
{{--                                             src="{{asset('admin/dist/img/no_image.jpg') }}"--}}
{{--                                             style="max-width: 100%; max-height: 300px; margin-left: 70px;"--}}
{{--                                             alt="No Video">--}}
{{--                                    </div>--}}
