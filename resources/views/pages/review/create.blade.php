...
{{--                        </div>--}}
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form class="custom-validation" action="{{route('admin.review.store')}}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="name" value="{{old('name')}}"
                                               class="form-control" required placeholder="enter review name here..."/>
                                        @error('name')
                                        <span class="text-danger" role="alert">
                                        <strong>{{$message}}</strong>
                                    </span>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <select name="stars_numbers" class="form-control" required>
