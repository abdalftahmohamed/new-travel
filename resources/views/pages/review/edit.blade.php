            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form class="custom-validation" action="{{route('admin.review.update')}}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <select id="client_id" name="client_id" class="form-control" >
                                            <option value="" disabled selected>{{$review->client->name ?? "Select Here"}}</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select id="trip_id" name="trip_id" class="form-control">
                                                <option value="" disabled selected>{{$review->trip->name ?? "Select Here"}}</option>
                                                @foreach($trips as $trip)
                                                    <option value="{{ $trip->id }}" {{ old('trip_id') == $trip ? 'selected' : '' }}>{{ $trip->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('trip_id')
                                            <span class="text-danger" role="alert">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select id="blog_id" name="blog_id" class="form-control">
                                                <option value="" disabled selected>{{$review->blog->name ?? "Select Here"}}</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select id="offer_id" name="offer_id" class="form-control" >
                                                <option value="" disabled selected>{{$review->offer->name ?? "Select Here"}}</option>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <select name="stars_numbers" class="form-control" >
                                            <option selected disabled value="">{{$review->stars_numbers ?? "Choose..."}}</option>
                                            <option
                                                value="1" {{ old('stars_numbers') == '1' ? 'selected' : '' }}>
                                                1
                                            </option>
                                            <option
                                                value="2" {{ old('stars_numbers') == '2' ? 'selected' : '' }}>
                                                2
                                            </option>
                                            <option
                                                value="3" {{ old('stars_numbers') == '3' ? 'selected' : '' }}>
                                                3
                                            </option>

                                            <option
                                                value="4" {{ old('stars_numbers') == '4' ? 'selected' : '' }}>
                                                4
                                            </option>

                                            <option
                                                value="5" {{ old('stars_numbers') == '5' ? 'selected' : '' }}>
                                                5
                                            </option>
                                ...
                                <div class="row">
                                    <div class="col-md-auto">
                                        <div class="DocumentSection_section__3WaJL">
                                            <div class="DocumentSection_sectionTitle__1rl5y">Photo
                                            ...
                                            <div class="DocumentEditScreen_titleDescription__2abbu">Add photo directly
                                                in your document and give your reviews a clearer picture of your
                                    ...
                                    <div class="col-md-auto">
                                        <img id="showImage" class="rounded avatar-lg"
                                             src="{{(! empty($review->image_path)) ? asset('attachments/reviews/'.$review->id.'/'.$review->image_path ) : asset('admin/dist/img/no_image.jpg') }}"
